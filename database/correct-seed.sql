-- Correct SQL seed for InstaSell database based on actual schema
...
INSERT INTO products (id, title, description, price, "originalPrice", condition, "categoryId", "sellerId", status, "isActive", "createdAt", "updatedAt")
VALUES 
    ('prod1', 'iPhone 15 Pro Max 256GB', 'Latest iPhone with amazing camera and performance. Brand new in box.', 999.99, 1199.99, 'NEW', 'cat1', 'user2', 'ACTIVE', true, NOW(), NOW()),
    ('prod2', 'MacBook Pro 16" M3 Pro', 'Powerful laptop for professionals. Excellent condition.', 2499.99, 2799.99, 'LIKE_NEW', 'cat1', 'user2', 'ACTIVE', true, NOW(), NOW()),
    ('prod3', 'Designer Leather Jacket', 'Genuine leather jacket, size M. Worn only a few times.', 299.99, 599.99, 'GOOD', 'cat2', 'user2', 'ACTIVE', true, NOW(), NOW()),
    ('prod4', 'Garden Furniture Set', 'Complete outdoor dining set for 6 people. Good condition.', 399.99, 699.99, 'GOOD', 'cat3', 'user2', 'ACTIVE', true, NOW(), NOW()),
    ('prod5', 'Mountain Bike', 'Professional mountain bike, 21 speeds. Excellent condition.', 599.99, 899.99, 'LIKE_NEW', 'cat4', 'user2', 'ACTIVE', true, NOW(), NOW()),
    ('prod6', 'Programming Books Bundle', 'Collection of 10 programming books. Like new condition.', 89.99, 150.00, 'LIKE_NEW', 'cat5', 'user2', 'ACTIVE', true, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO auctions (id, "productId", "startTime", "endTime", "startPrice", "currentPrice", "bidCount", "minBidIncrement", status, "createdAt", "updatedAt")
VALUES 
...
-- Insert sample bids
INSERT INTO auction_bids (id, "auctionId", "bidderId", amount, "isWinning", "createdAt")
VALUES 
    ('bid1', 'auc1', 'user1', 850.00, true, NOW() - INTERVAL '30 minutes'),
    ('bid2', 'auc2', 'user1', 2350.00, true, NOW() - INTERVAL '1 hour'),
    ('bid3', 'auc3', 'user1', 550.00, true, NOW() - INTERVAL '45 minutes')
ON CONFLICT (id) DO NOTHING;
